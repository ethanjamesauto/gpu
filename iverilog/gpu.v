...
module DIG_ROM_65536X8_spritememory (
    input [15:0] A,
    input sel,
    output reg [7:0] D
);
...
module gpu (
  ...
  // sprite memory
  DIG_ROM_65536X8_spritememory DIG_ROM_65536X8_spritememory_i2 (
    .A( addr_rom_temp ),
    .sel( load_rom_temp ),
    .D( data_temp )
  );
  ...
  assign data_0 = (data_temp[0] & load_rom_temp);
  assign s1 = s0[0];
  assign s2 = s0[1];
  assign s3 = s0[2];
  \74138_modified  \74138_modified_i4 (
    .A( s1 ),
    .B( s2 ),
    .C( s3 ),
    .\~GA ( 1'b0 ),
  ...
  \8bit_register  \8bit_register_i5 (
    .clk( clk ),
    .D( data_temp ),
    .en( s5 ),
    .Q( s16 )
  );
  assign store_ram_temp = (drawing & (fill | data_0));
  memory_ptr memory_ptr_i6 (
    .in0( data_temp ),
    .en( s13 ),
    .\~ld0 ( load_5 ),
    .in1( data_temp ),
  ...
  assign addr_ram_temp[7:0] = s7;
  assign addr_ram_temp[15:8] = s8;
  assign reset = ((s20 & s18) | done);
  assign s17 = ~ s19;
  assign s13 = ~ fill;
  assign addr_ram = addr_ram_temp;
  assign data = data_temp;
  assign addr_rom = addr_rom_temp;
  assign store_ram = store_ram_temp;
